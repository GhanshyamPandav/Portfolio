...
const projects = [
  {
    ...
    url: "Stock.ai",
    image:
      "https://api.builder.io/api/v1/image/assets/TEMP/1679745e2a064970ed0aebce6c9889bcdf2e840e?width=865",
    role: "Lead UX/UI Designer",
    year: "2023",
    fullDescription:
      "A modern AI-powered investment dashboard designed to simplify financial decision-making. I led the UI/UX redesign focusing on clean aesthetics, thoughtful interactions, and meaningful insights visualization.",
  ...
  },
  {
    ...
    url: "TaskRio.com",
    image:
      "https://api.builder.io/api/v1/image/assets/TEMP/5b39d1380b87784d13682daf309f7178611fa930?width=865",
    role: "Senior UX/UI Designer",
    year: "2023",
    fullDescription:
      "TaskRio is an intelligent task automation platform that helps teams streamline workflows. I designed the complete user interface with focus on usability, accessibility, and modern design patterns.",
  ...
  },
  {
    ...
    year: "2022",
    fullDescription:
      "Advanced project management interface with collaborative features. Designed with enterprise users in mind, ensuring scalability, intuitive navigation, and seamless team collaboration.",
...
export default function Index() {
  ...
  const socialLinks = [
    {
      icon: Github,
      url: "https://github.com/ghanshyampandav",
      label: "GitHub",
    },
    {
      icon: Linkedin,
      url: "https://www.linkedin.com/in/ghanshyampandav",
      label: "LinkedIn",
    },
    {
      icon: () => (
          ...
          >
            ...
            <div className="p-6 sm:p-10">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-sm font-semibold text-[#000] mb-2">
                    Role
                  </h3>
                ...
                <div>
                  <h3 className="text-sm font-semibold text-[#000] mb-3">
                    Technologies
                  </h3>
        ...
        <div className="scroll-container bg-white animate-slide-in-left">
          <div className="px-4 xs:px-5 sm:px-6 md:px-8 lg:px-10 py-6 xs:py-7 sm:py-8 md:py-10">
            <div className="w-full max-w-[550px] mx-auto flex flex-col gap-6 sm:gap-7 md:gap-8">
              {/* Header */}
              <div
                className="flex flex-col gap-3 xs:gap-4 w-full animate-fade-in-up"
                ...
                <div className="flex flex-col xs:flex-row items-start xs:items-center gap-2 xs:gap-3 flex-wrap">
                  ...
                  <div className="flex items-center gap-1 xs:gap-1.5 flex-wrap">
                    <div className="flex items-center gap-1 px-2.5 xs:px-3 py-1 xs:py-1.5 rounded-full bg-[rgba(0,0,0,0.05)] backdrop-blur-sm flex-shrink-0 transition-all hover:bg-[rgba(0,0,0,0.1)]">
                      <span className="text-xs xs:text-sm flex-shrink-0">
                        🌍
                      </span>
                      <span className="text-[10px] xs:text-xs text-[#000] whitespace-nowrap">
                        {dynamicInfo.location}
                      </span>
                    </div>
                    <div className="flex items-center gap-1 px-2.5 xs:px-3 py-1 xs:py-1.5 rounded-full bg-[rgba(0,0,0,0.05)] backdrop-blur-sm flex-shrink-0 transition-all hover:bg-[rgba(0,0,0,0.1)]">
                      <span className="text-xs xs:text-sm flex-shrink-0">
              ...
              >
                <div className="rounded-[20px] border border-[rgba(0,0,0,0.08)] bg-white shadow-[0_4px_30px_rgba(0,0,0,0.08)] p-5 sm:p-6 transition-all hover:shadow-[0_8px_40px_rgba(0,0,0,0.12)]">
                  ...
                  <div className="flex flex-col gap-3 xs:gap-4 sm:gap-5">
                    <div className="flex flex-col gap-0.5 xs:gap-1">
                      <h1 className="text-base xs:text-lg sm:text-xl font-semibold text-[#000]">
                        Ghanshyam Pandav
                      </h1>
                      <p className="text-[11px] xs:text-xs sm:text-sm text-[#808080]">
                    ...
                    <div className="flex flex-col gap-2 xs:gap-3">
                      <div className="flex items-center gap-2 xs:gap-3">
                        <span className="text-[9px] xs:text-[10px] sm:text-[11px] text-[#999999] uppercase tracking-[1.2px] font-mono">
                          // About
                        </span>
                      </div>
                      <div className="text-[11px] xs:text-xs sm:text-sm font-light text-[#333333] text-justify leading-relaxed">
                        <p className="mb-2 xs:mb-2.5">
                          For me, design goes beyond visuals — it's about
                          solving real problems. I craft clean, modern,
                          human-centered experiences that connect people with
                          brands.
                        </p>
                        <p className="mb-2 xs:mb-2.5">
                          With nearly 5 years as a Senior UX/UI Designer, I've
                          built digital products that put people first —
                          blending clean aesthetics, thoughtful interactions,
                          and meaningful impact.
                        </p>
                        <p>
                          I leverage AI to boost productivity and accelerate
                          iteration — from copywriting and user research to
                ...
                {/* Skills Section */}
                <div
                  className="flex flex-col gap-3 xs:gap-4 animate-fade-in-up"
                ...
                >
                  ...
                  <div className="rounded-[20px] border border-[rgba(0,0,0,0.08)] bg-white shadow-[0_4px_30px_rgba(0,0,0,0.08)] p-5 sm:p-6 flex flex-col gap-4 xs:gap-5 transition-all hover:shadow-[0_8px_40px_rgba(0,0,0,0.12)]">
                    ...
                    <div className="transition-all">
                      ...
                      >
                        <span className="text-sm xs:text-base font-semibold text-[#000]">
                          Core Skills
                        </span>
                      ...
                      <div
                        className={`skill-section ${!expandedSkills.core ? "collapsed" : ""}`}
                      >
                    ...
                    <div className="border-t border-[rgba(0,0,0,0.08)] pt-4">
                      ...
                      <div
                        className={`skill-section ${!expandedSkills.research ? "collapsed" : ""}`}
                      >
                    ...
                    <div className="border-t border-[rgba(0,0,0,0.08)] pt-4">
                      ...
                      <div
                        className={`skill-section ${!expandedSkills.tools ? "collapsed" : ""}`}
                      >
                        <div className="flex gap-2 xs:gap-3 flex-wrap mt-3">
                ...
                {/* Experience Section */}
                <div
                  className="flex flex-col gap-3 xs:gap-4 animate-fade-in-up pb-10"
                      ...
                      >
                        <div className="flex items-center gap-3 xs:gap-4 flex-1 min-w-0">
                          ...
                          <div className="flex flex-col gap-0.5 xs:gap-1 min-w-0 flex-1">
                            <p className="text-[10px] xs:text-xs text-[#999999] truncate">
                              {exp.company}
                            </p>
                            <p className="text-xs xs:text-sm sm:text-base font-semibold text-[#000] leading-tight">
                              {exp.role}
                            </p>
                            <p className="text-[9px] xs:text-[10px] text-[#999999]">
                              {exp.location}
                            </p>
                          </div>
                        </div>
                        <span className="text-[9px] xs:text-xs sm:text-sm font-light text-[#999999] flex-shrink-0 whitespace-nowrap">
                          {exp.period}
                        </span>
                      </div>
                    ))}
  ...
  return (
    ...
    >
      ...
      <div className="p-3 xs:p-4 sm:p-5 flex items-center justify-between gap-2 xs:gap-3 border-b border-[rgba(0,0,0,0.06)]">
        <div className="flex items-center gap-2 xs:gap-3 min-w-0 flex-1">
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#F5F5F5] flex-shrink-0">
            ...
            <span className="text-[8px] xs:text-[9px] text-[#999] uppercase tracking-[0.5px] font-mono">
              https://
            </span>
          </div>
          <span className="text-[10px] xs:text-xs sm:text-sm text-[#333] truncate font-medium">
            {url}
          </span>
        </div>
      ...
      <div className="p-3 xs:p-4 sm:p-5 flex flex-col gap-1.5 xs:gap-2">
        ...
        <p className="text-[10px] xs:text-xs text-[#666] line-clamp-2">
          {project.description}
        </p>
      </div>
    </button>
